            ...
            <div class="hidden md:block overflow-x-auto">
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                        ...
                        @empty
                                                    <tr>
                                                        <td colspan="5" class="px-6 py-20 text-center text-slate-400 italic font-medium"><div class="flex flex-col items-center justify-center p-12 text-center bg-slate-50/50 dark:bg-slate-800/30 rounded-2xl border border-dashed border-slate-200 dark:border-slate-700 m-4">
                                <!-- Icon SVG Kotak Kosong Minimalis -->
                                <div class="p-3 bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 text-slate-400 dark:text-slate-500 mb-4 animate-pulse">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 13.5h3.86a2.25 2.25 0 012.008 1.24l.885 1.77a2.25 2.25 0 002.007 1.24h1.98a2.25 2.25 0 002.007-1.24l.885-1.77a2.25 2.25 0 012.007-1.24h3.86m-18 0h18a2.25 2.25 0 012.25 2.25v4.5A2.25 2.25 0 0118 21H6a2.25 2.25 0 01-2.25-2.25v-4.5a2.25 2.25 0 012.25-2.25zM6.75 6.75h.008v.008H6.75V6.75zm.375 0a.375 0 11-.75 0 .375 0 01.75 0zM12 6.75h.008v.008H12V6.75zm.375 0a.375 0 11-.75 0 .375 0 01.75 0zm5.625 0h.008v.008h-.008V6.75zm.375 0a.375 0 11-.75 0 .375 0 01.75 0z" />
                                    </svg>
                                </div>
                                ...
                                <p class="text-xs text-slate-400 dark:text-slate-500 max-w-xs font-medium">
                                    Data kelas perkuliahan untuk semester aktif ini masih kosong atau belum disinkronkan.
                                </p>
                            </div></td>
                                                    </tr>
                        @endforelse
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
                                ...
                                <div class="lg:col-span-6 flex flex-col text-left">
                                    ...
                                    <div class="flex-1 pr-3 space-y-4">
                                        ...
                                        @else
                                            <p class="text-xs italic text-slate-400">Tidak ada data angkatan yang sesuai.</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal__overlay" tabindex="-1" data-micromodal-close>
                    <div class="modal__container w-full max-w-sm text-center bg-white dark:bg-slate-800 rounded-4xl p-8 shadow-2xl border-none dark:border dark:border-slate-700"
                        ...
                        <p class="text-sm text-slate-500 dark:text-slate-400 mb-8 leading-relaxed">
                            Menghapus kelas <b>{{ $kelas->nama_kelas }}</b> akan menghapus semua data relasi golongan dan rekaman presensi mahasiswa secara permanen. Lanjutkan?
                        </p>

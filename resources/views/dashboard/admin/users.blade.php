...
<div class="space-y-6 mx-auto p-2 sm:p-4 text-left">
    ...
    <!-- Filter & Search Bar (Responsive Stacked on Mobile) -->
    ...
    <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-4xl sm:rounded-[2.5rem] overflow-hidden shadow-xs">
        ...
        <!-- DESKTOP VIEW TABLE (Hanya nampil di md ke atas) -->
        ...
        <!-- MOBILE STACKED CARD VIEW (Hanya nampil di HP / md:hidden) -->
...
<!-- ======================================================== -->
<!-- MODAL ZONE: ALL WRAPPED SAFELY & FULLY RESPONSIVE CUK -->
<!-- ======================================================== -->
@foreach($users as $user)
<!-- Modal Detail User (Slide In Animated) -->
...
<!-- Modal Control Akses / Lock User Account -->
